...
/// Fast access to emoji categories' name
final Map<String, Map> emojiMapName = {
  'smileys': smileys,
  'animals': animals,
  'foods': foods,
  'travel': travel,
...
/// Fast access to emoji categories' icon
final Map<String, IconData> emojiMapIcon = {
  'smileys': Icons.tag_faces,
  'animals': Icons.pets,
  'foods': Icons.fastfood,
  'travel': Icons.location_city,
  'activities': Icons.directions_run,
  'objects': Icons.lightbulb_outline,
  'symbols': Icons.euro_symbol,
  'flags': Icons.flag,
};
